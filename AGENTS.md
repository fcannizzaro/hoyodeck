...
You can use
- `bun run build` to check if the plugin builds correctly
## 1. Simplicity
...
export class ResinAction extends StaminaAction<ResinSettings> {
  protected readonly game = 'genshin';
...
export const GAMES: Record<GameId, GameConfig> = {
  genshin: {
    ...
    regions: { '6': 'os_usa', '7': 'os_euro', '8': 'os_asia' },
  },
  // ... other games
};
```
...
│   ├── genshin/        # Genshin-specific actions
│   ├── starrail/       # Star Rail actions (future)
│   └── zzz/            # ZZZ actions (future)
├── api/
│   ├── hoyolab/        # HoYoLAB API client
│   └── games/          # Game-specific API adapters
