...
export const GAMES: Record<GameId, GameConfig> = {
  gi: {
    ...
    cnBattleChronicleUrl: "https://www.miyoushe.com/ys/",
    staminaMax: 200,
    ...
    cnCheckInActId: "e202311201442471",
    cnCheckInBaseUrl: "https://api-takumi.mihoyo.com",
    cnCheckInPath: "/event/luna/hk4e",
    signGameHeader: "hk4e",
    regions: {
      "1": "cn_gf01",
      "2": "cn_gf01",
  ...
  hsr: {
    ...
    cnBattleChronicleUrl: "https://www.miyoushe.com/sr/",
    ...
    cnCheckInActId: "e202304121516551",
    cnCheckInBaseUrl: "https://api-takumi.mihoyo.com",
    cnCheckInPath: "/event/luna/hkrpg",
  ...
  zzz: {
    ...
    cnBattleChronicleUrl: "https://www.miyoushe.com/zzz/",
    ...
    cnCheckInActId: "e202406242138391",
    cnCheckInBaseUrl: "https://api-takumi.mihoyo.com",
    cnCheckInPath: "/event/luna/zzz",
    signGameHeader: "zzz",
    regions: {
      "10": "prod_gf_us",
      "13": "prod_gf_jp",
...
/** Extended display names for each game */
export const GAME_LABELS_EXTENDED: Record<GameId, string> = {
  gi: "Genshin Impact",
