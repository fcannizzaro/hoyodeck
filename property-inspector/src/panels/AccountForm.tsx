...
export function AccountForm({ account, onSave, onCancel }: AccountFormProps) {
  ...
  const pendingLogin = globalSettings.pendingLogin as
    | PendingLogin
    | undefined;
      ...
      {loginAuth ? (
        ...
        <>
          ...
          {isPolling ? (
            ...
            <p className="text-[11px] text-sd-secondary">
              Opens a browser window. Cookies will be auto-detected after you
              log in.
            </p>
          )}
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-sd-secondary uppercase tracking-wider">
              or
            </span>
            <div className="flex-1 h-px bg-sd-border" />
          </div>
